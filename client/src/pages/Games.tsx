...
export default function Games() {
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold text-gray-700 mb-6">Select to Play:</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {games.map((game) => (
          <button
            key={game.id}
            onClick={() => handleSelectGame(game.id, game.name)}
            className="bg-gray-100 shadow  p-6 text-center hover:bg-gray-400 transition-colors duration-200"
          >
